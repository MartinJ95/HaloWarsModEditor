...
{
    {
        ...
        for (int i = 0; i < leaders.size(); i++)
        {
            std::vector<EditBoxVals> vals{
                ...
                {"UI Control Background", leaders[i].flashDetails.UIControlBackground, &leaders[i].flashDetails.UIControlBackground, VarType::eString, wxPoint(), (wxFrame*)parent, 0},
                ...
                {"starting unit offset.x :", std::to_string(leaders[i].startProperties.startUnit.offset.x), &leaders[i].startProperties.startUnit.offset.x, VarType::eInt, wxPoint(), (wxFrame*)parent, 0},
                {"starting unit offset.x :", std::to_string(leaders[i].startProperties.startUnit.offset.y), &leaders[i].startProperties.startUnit.offset.y, VarType::eInt, wxPoint(), (wxFrame*)parent, 0},
                {"starting unit offset.x :", std::to_string(leaders[i].startProperties.startUnit.offset.z), &leaders[i].startProperties.startUnit.offset.z, VarType::eInt, wxPoint(), (wxFrame*)parent, 0},
                {"starting unit build other: ", leaders[i].startProperties.startUnit.buildOther, &leaders[i].startProperties.startUnit.buildOther, VarType::eString, wxPoint(), (wxFrame*)parent, 0},
                {"starting Unit dopple on start: ", std::string(leaders[i].startProperties.startUnit.doppleOnStart ? "true" : "false"), &leaders[i].startProperties.startUnit.doppleOnStart, VarType::eBool, wxPoint(), (wxFrame*)parent, 0},
                ...
                { "repair rate: ", std::to_string(leaders[i].repairProperties.repairRate), &leaders[i].repairProperties.repairRate, VarType::eInt, wxPoint(), (wxFrame*)parent, 0},
                { "repair delay: ", std::to_string(leaders[i].repairProperties.repairDelay), &leaders[i].repairProperties.repairDelay, VarType::eInt, wxPoint(), (wxFrame*)parent, 0},
                {"repair cost type: ", leaders[i].repairProperties.repairCost.first, &leaders[i].repairProperties.repairCost.first, VarType::eString, wxPoint(), (wxFrame*)parent, 0},
                {"repair cost amount: ", std::to_string(leaders[i].repairProperties.repairCost.second), &leaders[i].repairProperties.repairCost.second, VarType::eInt, wxPoint(), (wxFrame*)parent, 0},
                { "repair time: ", std::to_string(leaders[i].repairProperties.repairTime), &leaders[i].repairProperties.repairTime, VarType::eInt, wxPoint(), (wxFrame*)parent, 0}
            };
